...
public class LogeoActivity extends AppCompatActivity {
    ...
    private void initGoogleSignIn(){
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("987314962499-blm8ppn40dm9h5j83jafvcpf04sbne6e.apps.googleusercontent.com")
                .requestEmail()
                .build();
                            ...
                            .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        ...
                                        Toast.makeText(LogeoActivity.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
    ...
    public void callLogin(View view){
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Log.d(TAG, "Ingreso exitoso:" + task.isSuccessful());
                        if (!task.isSuccessful()) {
                            loginPanel.setVisibility(View.VISIBLE);
                            progressBar.setVisibility(View.GONE);
                            Log.e(TAG, "Ingreso fallido", task.getException());
                            Toast.makeText(LogeoActivity.this, "Correo o Contraseña es incorrecta", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    public void callRegister(View view){
        ...
        if(password.length() < 6){
            Toast.makeText(this, "6 a más caracteres para la contraseña", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Log.d(TAG, "Usuario creado con exito:" + task.isSuccessful());
                        if (!task.isSuccessful()) {
                            loginPanel.setVisibility(View.VISIBLE);
                            progressBar.setVisibility(View.GONE);
                            Log.e(TAG, "Fallo al crear usuario", task.getException());
                            Toast.makeText(LogeoActivity.this, "Register failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LogeoActivity.this, "Bienvenido a Kiraw" , Toast.LENGTH_SHORT).show();

                    // Go MainActivity
                    startActivity(new Intent(LogeoActivity.this, HomeActivity.class));
                    finish();
